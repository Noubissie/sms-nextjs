...
<Navbar id="vnav" className="w-100 m-0 p-0 flex-column"    fluid="true">
        <Navbar.Brand className="m-6 d-md-none">
            <i>
                GBHS MOTENGENE
            </i>
        </Navbar.Brand> 
        ...
        <Navbar.Collapse id="basic-navbar-nav" className="w-100 m-0 p-0" >
            ...
            <Card className=" color-nav-menu text-light mb-1">
                        <Accordion.Toggle as={Card.Header} eventKey="section">
                            <i className="pl-3"><FaBookOpen color="yellow" size="25"/></i><span className="p-2">section</span>
...
//     <button className="position-fixed t-0 zIndex3 d-none d-md-block border border-none bg-warning  m-0 p-0" onClick={props.onclick}><FaUikit size="32" color="blue"/></button>
// </div>
// <Navbar id="vnav" className="w-100 m-0 p-0 flex-column d-md-none position"    fluid="true">
