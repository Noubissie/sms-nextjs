        ...
        <Navbar.Collapse  id="basic-navbar-nav" className="w-100 m-0 p-0 nobackground " >
            ...
            <Card className=" color-nav-menu  mb-1 nobackground  navwidth noborder white">
                        <Accordion.Toggle  eventKey="section" className="pixel15 nobackground border border-secondary p-2 white">
                            <i className="pl-3 float-left"><FaBookOpen color="smokewhite" size="20"/></i><span className=" p-2 ml-1 ">Section</span>
                            <i className=" float-right"> <FaPlus color="smokewhite" size="14" /></i>
                        </Accordion.Toggle>
                    ...
                    <Card className=" color-nav-menu  mb-1 nobackground  navwidth noborder white">
                        <Accordion.Toggle className="pixel15 nobackground border border-secondary p-2 white" eventKey="class">
                            <i className="pl-3 float-left"><FaDoorOpen color="smokewhite" size="20"/></i><span className="p-2">Class</span>
                            <i className=" float-right"> <FaPlus color="smokewhite" size="14" /></i>
                        </Accordion.Toggle>
                    ...
                    <Card className=" color-nav-menu  mb-1 nobackground  navwidth noborder white">
                        <Accordion.Toggle className="pixel15 nobackground border border-secondary p-2 white" eventKey="subject">
                            <i className="pl-3 float-left"><FaBookOpen color="smokewhite" size="20"/></i><span className="p-2">Subject</span>
                            <i className=" float-right"> <FaPlus color="smokewhite" size="14" /></i>
                        </Accordion.Toggle>
                ...
                <Card className=" color-nav-menu  mb-1 nobackground  navwidth noborder white">
                    <Accordion.Toggle className="pixel15 nobackground border border-secondary p-2 white" eventKey="DashBoard">
                        <i className="pl-3 float-left"><FaLifeRing  color="smokewhite" size="20" /></i><span className="p-2">Dashboard</span>
                        <i className=" float-right"> <FaPlus color="smokewhite" size="14" /></i>
                    </Accordion.Toggle>
                ...
                <Card className=" color-nav-menu  mb-1 nobackground  navwidth noborder white">
                    <Accordion.Toggle className="pixel15 nobackground border border-secondary p-2 white" eventKey="students">
                        <i className="pl-3 float-left"><FaUserPlus color="smokewhite" size="20"/></i><span className="p-2">Students</span>
                        <i className=" float-right"> <FaPlus color="smokewhite" size="14" /></i>
                    </Accordion.Toggle>
                ...
                <Card className=" color-nav-menu  mb-1 nobackground  navwidth noborder white">
                    <Accordion.Toggle className="pixel15 nobackground border border-secondary p-2 white" eventKey="Teacher">
                        <i className="pl-3 float-left"><FaChalkboardTeacher color="smokewhite" size="20"/></i><span className="p-2">Teachers</span>
                        <i className=" float-right"> <FaPlus color="smokewhite" size="14" /></i>
                    </Accordion.Toggle>
                    ...
                    <Card className=" color-nav-menu  mb-1 nobackground  navwidth noborder white">
                        <Accordion.Toggle className="pixel15 nobackground border border-secondary p-2 white" eventKey="parents">
                            <i className="pl-3 float-left"><FaUserFriends color="smokewhite" size="20"/></i><span className="p-2">Parents</span>
                            <i className=" float-right"> <FaPlus color="smokewhite" size="14" /></i>
                        </Accordion.Toggle>
                    ...
                    <Card className=" color-nav-menu  mb-1 nobackground  navwidth noborder white">
                        <Accordion.Toggle className="pixel15 nobackground border border-secondary p-2 white" eventKey="library">
                            <i className="pl-3 float-left"><FaBookReader color="smokewhite" size="20"/></i><span className="p-2">Library</span>
                            <i className=" float-right"> <FaPlus color="smokewhite" size="14" /></i>
                        </Accordion.Toggle>
                    ...
                    <Card className=" color-nav-menu  mb-1 nobackground  navwidth noborder white">
                        <Accordion.Toggle className="pixel15 nobackground border border-secondary p-2 white" eventKey="Accounts">
                            <i className="pl-3 float-left"><FaMoneyCheckAlt color="smokewhite" size="20"/></i><span className="p-2">Accounts</span>
                            <i className=" float-right"> <FaPlus color="smokewhite" size="14" /></i>
                        </Accordion.Toggle>
                    ...
                    <Card className=" color-nav-menu  mb-1 nobackground  navwidth noborder white">
                        <Accordion.Toggle className="pixel15 nobackground border border-secondary p-2 white" eventKey="classRoutine">
                            <i className="pl-3 float-left"><FaCalendarAlt color="smokewhite" size="20"/></i><span className="p-2">Class Routines</span>
                            <i className=" float-right"> <FaPlus color="smokewhite" size="14" /></i>
                        </Accordion.Toggle>
                    ...
                    <Card className=" color-nav-menu  mb-1 nobackground  navwidth noborder white">
                        <Accordion.Toggle className="pixel15 nobackground border border-secondary p-2 white" eventKey="Attendance">
                            <i className="pl-3 float-left"><FaCalendarCheck color="smokewhite" size="20"/></i><span className="p-2">Attendance</span>
                            <i className=" float-right"> <FaPlus color="smokewhite" size="14" /></i>
                        </Accordion.Toggle>
                    ...
                    <Card className=" color-nav-menu  mb-1 nobackground  navwidth noborder white">
                        <Accordion.Toggle className="pixel15 nobackground border border-secondary p-2 white" eventKey="Exams">
                            <i className="pl-3 float-left"><FaPagelines color="smokewhite" size="20"/></i><span className="p-2">Exams</span>
                            <i className=" float-right"> <FaPlus color="smokewhite" size="14" /></i>
                        </Accordion.Toggle>
                    ...
                    <Card className=" color-nav-menu  mb-1 nobackground  navwidth noborder white">
                        <Accordion.Toggle className="pixel15 nobackground border border-secondary p-2 white" eventKey="Transport">
                            <i className="pl-3 float-left"><FaBusAlt color="smokewhite" size="20"/></i><span className="p-2">Transport</span>
                            <i className=" float-right"> <FaPlus color="smokewhite" size="14" /></i>
                        </Accordion.Toggle>
                    ...
                    <Card className=" color-nav-menu  mb-1 nobackground  navwidth noborder white">
                        <Accordion.Toggle className="pixel15 nobackground border border-secondary p-2 white" eventKey="Hostel">
                            <i className="pl-3 float-left"><FaWarehouse color="smokewhite" size="20"/></i><span className="p-2">Hostel</span>
                            <i className=" float-right"> <FaPlus color="smokewhite" size="14" /></i>
                        </Accordion.Toggle>
                    ...
                    <Card className=" color-nav-menu  mb-1 nobackground  navwidth noborder white">
                        <Accordion.Toggle className="pixel15 nobackground border border-secondary p-2 white" eventKey="Notice">
                            <i className="pl-3 float-left"><FaInfo color="smokewhite" size="20"/></i><span className="p-2">Notice</span>
                            <i className=" float-right"> <FaPlus color="smokewhite" size="14" /></i>
                        </Accordion.Toggle>
                    ...
                    <Card className=" color-nav-menu  mb-1 nobackground  navwidth noborder white">
                        <Accordion.Toggle className="pixel15 nobackground border border-secondary p-2 white" eventKey="Message">
                            <i className="pl-3 float-left"><FaEnvelopeOpenText color="smokewhite" size="20"/></i><span className="p-2">Message</span>
                            <i className=" float-right"> <FaPlus color="smokewhite" size="14" /></i>
                        </Accordion.Toggle>
                    ...
                    <Card className=" color-nav-menu  mb-1 nobackground  navwidth noborder white">
                        <Accordion.Toggle className="pixel15 nobackground border border-secondary p-2 white" eventKey="ui-Elements">
                            <i className="pl-3 float-left"><FaUikit color="smokewhite" size="20"/></i><span className="p-2">UI-Elements</span>
                            <i className=" float-right"> <FaPlus color="smokewhite" size="14" /></i>
                        </Accordion.Toggle>
                    ...
                    <Card className=" color-nav-menu  mb-1 nobackground  navwidth noborder white">
                        <Accordion.Toggle className="pixel15 nobackground border border-secondary p-2 white" eventKey="map">
                            <i className="pl-3 float-left"><FaMapMarkedAlt color="smokewhite" size="20"/></i><span className="p-2">Map</span>
                            <i className=" float-right"> <FaPlus color="smokewhite" size="14" /></i>
                        </Accordion.Toggle>
                    ...
                    <Card className=" color-nav-menu  mb-1 nobackground  navwidth noborder white">
                        <Accordion.Toggle className="pixel15 nobackground border border-secondary p-2 white" eventKey="userAccount">
                            <i className="pl-3 float-left"><FaUser color="smokewhite" size="20"/></i><span className="p-2">User Account</span>
                            <i className=" float-right"> <FaPlus color="smokewhite" size="14" /></i>
                        </Accordion.Toggle>
